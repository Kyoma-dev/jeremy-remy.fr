document.addEventListener("DOMContentLoaded", () => {
    // Vérifier si la page actuelle est "page-freelance"
    if (document.body.classList.contains("page-freelance")) {
        console.log("Animation du logo et gestion de la navbar activée pour la page freelance.");
        ...
        console.log("Aucune animation ou gestion spéciale pour cette page.");
    }
});
